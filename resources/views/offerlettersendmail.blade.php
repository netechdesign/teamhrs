                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <p>Please click the link below to view and sign your offer letter and contract.</p>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="{{ url('/offer-letter/'.$data['code']) }}"
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <p>
                                        @if($data['is_other_documents'])
                                        @foreach($data['other_documents'] as $vl)
                                        {{$vl['document_name']}} ,
                                        @endforeach
                                        @endif
                                        </p>
                                        ...
                                        <table border="0"  width="180" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    <div style="line-height: 22px;">
                                                        <a href="{{ url('/re-certification/'.$data['code']) }}"
                                                            style="color: #ffffff; text-decoration: none;">Click
                                                            here</a>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div
                                                        ...
                                                        <!--   Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">itsupportpeople.co.uk</a>
                                                     -->
                                                    </div>
                                                </td>
                                            </tr>
