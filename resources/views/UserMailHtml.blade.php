                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">Email : {{$content->email}}</p>
                                        <p style="line-height: 24px;margin-bottom:15px;">Password :
                                            {{$content->password}}</p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            This is your one time password.Please login and change password.
                                        </p>
