...
const routes = [
    ...
    { path:'/check-list/edit/:id',exact:true,name:'CheckListEdit',component:CheckListEdit},
    ...
    { path:'/employee-Detail/Mandatory-document', exact:true, name:'Oneform',component:EmployeeDetails},
