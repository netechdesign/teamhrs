...
class Proofofidentification extends React.Component {
    ...
    render() {
        return(<Aux>
            {(this.props.data?<tr><th>{this.getExt(this.props.data.birth_certificate)}</th><th>Birth Certificate</th><th><a target="_black" href={baseurl+'/uploaded/'+this.props.data.birth_certificate} className="btn-sm" style={{width: '20%',padding: '5px 0px'}} variant='secondary'><i style={{marginRight:'0px'}} class="fa fa-eye"></i></a></th></tr>:'')}
            {(this.props.data?<tr><th>{this.getExt(this.props.data.driving_licence_front)}</th><th>Driving Licence</th><th><a target="_black" href={baseurl+'/uploaded/'+this.props.data.driving_licence_front} className="btn-sm" style={{width: '20%',padding: '5px 0px'}} variant='secondary'><i style={{marginRight:'0px'}} class="fa fa-eye"></i></a></th></tr>:'')}
            
            {(this.props.data?<tr><th>{this.getExt(this.props.data.national_insurance_number)}</th><th>National Insurance Number</th><th><a target="_black" href={baseurl+'/uploaded/'+this.props.data.national_insurance_number} className="btn-sm" style={{width: '20%',padding: '5px 0px'}} variant='secondary'><i style={{marginRight:'0px'}} class="fa fa-eye"></i></a></th></tr>:'')}
            
            {(this.props.data?<tr><th>{this.getExt(this.props.data.p45form)}</th><th>p45 Form</th><th><a target="_black" href={baseurl+'/uploaded/'+this.props.data.p45form} className="btn-sm" style={{width: '20%',padding: '5px 0px'}} variant='secondary'><i style={{marginRight:'0px'}} class="fa fa-eye"></i></a></th></tr>:'')}
            ...
            {(this.props.data?<tr><th>{this.getExt(this.props.data.passport_inside)}</th><th>Passport</th><th><a target="_black" href={baseurl+'/uploaded/'+this.props.data.passport_inside} className="btn-sm" style={{width: '20%',padding: '5px 0px'}} variant='secondary'><i style={{marginRight:'0px'}} class="fa fa-eye"></i></a></th></tr>:'')}
            
            {(this.props.data?<tr><th>{this.getExt(this.props.data.proof_of_address)}</th><th>Proof of Address</th><th><a target="_black" href={baseurl+'/uploaded/'+this.props.data.proof_of_address} className="btn-sm" style={{width: '20%',padding: '5px 0px'}} variant='secondary'><i style={{marginRight:'0px'}} class="fa fa-eye"></i></a></th></tr>:'')}
            
            {(this.props.data?<tr><th>{this.getExt(this.props.data.right_to_work)}</th><th>Right to work</th><th><a target="_black" href={baseurl+'/uploaded/'+this.props.data.right_to_work} className="btn-sm" style={{width: '20%',padding: '5px 0px'}} variant='secondary'><i style={{marginRight:'0px'}} class="fa fa-eye"></i></a></th></tr>:'')}
            </Aux>);
    }
}
