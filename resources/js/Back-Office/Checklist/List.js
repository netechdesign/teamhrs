...
oTable = $(tableResponsive).DataTable({
    ...
    "fnServerParams": function (aoData) {
        ...
        if($('input[name="is_completed"]').val()!='') {
            console.log($('input[name="is_completed"]').val());
            aoData.push({name: 'is_completed', value: $('input[name="is_completed"]').val()});
        }
...
//oTable.fnAdjustColumnSizing();
    ...
    "columnDefs": [
        ...
        }, 
        {
            ...
            "targets": $('#data-table-responsive th#is_completed').index(),
            "orderable": false,
            "searchable": false
...
export const completedOptions = [
    ...
    { value: '1', label: 'Yes', color: '#00B8D9' },
    { value: '0', label: 'No', color: '#5243AA' },
...
class List extends React.Component {
  ...
  applicationShow= (application_id)=>{
    ...
    copletedstatus =(e) =>{
        setTimeout(function(){ oTable.ajax.reload();
        }, 500);
                            ...
                            <Card.Body>
                                <Table ref="tbl" striped hover responsive className="table table-condensed" id="data-table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <th id="is_completed" width="10%">Completed
                                        <Select
                                ...
                                />
                                    ...
                                    <th id="issued_date">Created at</th>
                                    <th id="issued_engineer_name">Engineer Name</th>
                                    <th id="is_completed">Completed</th>
                                     <th id="action">Action</th>
                                    </tr>
                                    </tfoot>
                                </Table>
