        ...
        <Aux>
                ...
                <Row>
                        <Col>
                            <Card>
                                    <Card.Header>
                                        <Card.Title as="h5">{(this.props.match.params.id?'Edit':'Add')} Holiday</Card.Title>
                                        <div class="invoice-lable text-right"  style={{position: 'absolute',top: '10px',right:'5px'}}>
                                       <NavLink  to= {{pathname:'/Holiday'}} className="shadow-5 btn-sm btn-info"><i class="fa fa-mail-reply"></i></NavLink> 
                                </div>
                                    </Card.Header>
                                    <Card.Body>
