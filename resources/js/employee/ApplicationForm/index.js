...
<Form.Group as={Col} md="2">
                                         ...
                                         <Form.Row style={style.rowline} >
                                              <Form.Group as={Col} md="12">
                                                    ...
                                                    <Form.Label htmlFor="selected_interview">If selected for interview, do you require any reasonable adjustments to be made on account of a disability? (delete as appropriate)</Form.Label>
                                            ...
                                            <Form.Row style={style.rowline} >
                                              <Form.Group as={Col} md="12">
                                                    ...
                                                    <Form.Label htmlFor="selected_interview">If selected for interview, do you require any reasonable adjustments to be made on account of a medical condition? (delete as appropriate)</Form.Label>
...
<Form.Row style={style.rowline} >
                                              <Form.Group as={Col} md="12">
                                                    ...
                                                    <Form.Label htmlFor="selected_interview">Have you any convictions that are not spent under the rehabilitation of offenders act? (delete as appropriate)</Form.Label>
                                                ...
                                                <Form.Group as={Col} md="12">
                                                    ...
                                                    <Form.Label htmlFor="selected_interview">Do you need a work permit to be employed in the UK? (delete as appropriate)</Form.Label>
